...
/**
 * Plugin manager for Wizard Step Plugins.
 */
class WizardStepPluginManager extends DefaultPluginManager implements ContextAwarePluginManagerInterface {
  use ContextAwarePluginManagerTrait;

  /**
   * Constructs a WizardStepPluginManager object.
   *
